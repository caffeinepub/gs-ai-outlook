...
import type { Email as _Email, UserProfile as _UserProfile, UserRole as _UserRole } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async createEvent(arg0: string, arg1: string, arg2: bigint, arg3: bigint, arg4: string): Promise<CalendarEvent> {
        if (this.processError) {
            try {
    ...
    async createTask(arg0: string, arg1: bigint, arg2: string): Promise<Task> {
        if (this.processError) {
            try {
    ...
    async getEmailById(arg0: string): Promise<Email | null> {
        if (this.processError) {
            try {
                const result = await this.actor.getEmailById(arg0);
    ...
    async getEmails(): Promise<Array<Email>> {
        if (this.processError) {
            try {
    ...
    async initDemoData(): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.initDemoData();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async markEmailRead(arg0: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.markEmailRead(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async rewriteBody(arg0: string, arg1: string): Promise<string> {
        if (this.processError) {
            try {
                const result = await this.actor.rewriteBody(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async summarizeEmail(arg0: string): Promise<string> {
        if (this.processError) {
            try {
                const result = await this.actor.summarizeEmail(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async toggleStarEmail(arg0: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.toggleStarEmail(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_opt_n6(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_Email]): Email | null {
    return value.length === 0 ? null : value[0];
}
